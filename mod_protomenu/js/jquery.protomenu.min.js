...
a=a.find(".nav-child");for(var b=0,c=a.length;b<c;b++)a.eq(b).data("ptmenu").triggers.removeClass(this.opt.classNames.open)},disableDescestors:function(a){a.find(".nav-child").removeClass(c.map(this.opt.classNames,function(a){return a}).join(" "))},hideSub:function(a){var b=a.css("transition-duration").split(","),d=a.data("ptmenu"),e=0;b.forEach(function(a){a=parseFloat(a);e=a>e?a:e});0<e?(d.timeout=window.setTimeout(function(a){a.removeClass(this.opt.classNames["in"]);this.disableDescestors(a)}.bind(this,
a),1E3*e),a.data("ptmenu",d),a.removeClass(this.opt.classNames.open)):(a.removeClass(c.map(this.opt.classNames,function(a){return a}).join(" ")),this.disableDescestors(a));this.$node.triggerHandler("afterStateChanged");this.disableTriggers(a)},showSub:function(a){var b=a.data("ptmenu");b.timeout&&window.clearTimeout(b.timeout);this.closeEqual(a);a.addClass(c.map(this.opt.classNames,function(a){return a}).join(" "));a.data("ptmenu").triggers.addClass(this.opt.classNames.open);this.$node.triggerHandler("afterStateChanged")},
closeRoot:function(){var a=this.$menu.find(".nav-child.nav-level-2."+this.opt.classNames.open);a.length&&this.hideSub(a)},closeEqual:function(a){a=a.parent().parent().find(".nav-child."+this.opt.classNames.open).not(a);for(var b=0,c=a.length;b<c;b++)this.hideSub(a.eq(b))},isExpanded:function(a){return(a?this.$menu.find(".nav-child.nav-level-2."+this.opt.classNames.open):this.$menu.find(".nav-child."+this.opt.classNames.open)).length?!0:!1},toggleSubmenu:function(a,b){if(a.data("ptmenu")){var d=a.data("ptmenu").submenu;
d.hasClass(this.opt.classNames.open)&&!b?(this.hideSub(d),a.blur()):this.showSub(d);if(b){var e=this;this.$menu.children("li").off("mousemove.protomenu").on("mousemove.protomenu",function(a){c(this).find("#"+d.attr("id")).length||(c(document).off("mousemove.protomenu"),e.closeRoot())});c(document).off("mousemove.protomenu").on("mousemove.protomenu",function(a){c(a.target).parents(".ptmenu").length||(c(document).off("mousemove.protomenu"),e.closeRoot())})}}else b&&this.closeEqual(a)}};c.fn.protomenu=
function(a){var b=c(this).data("protomenu");void 0===b&&(b=new c.Protomenu(a,this));return b}})(jQuery);
